...
CREATE TABLE IF NOT EXISTS `notizie` (
  `idnotizia` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `datan` DATETIME NOT NULL,
  `titolo` VARCHAR(70) NOT NULL UNIQUE,
...
INSERT INTO `campionato` (`idcampionato`, `logoc`, `nome`, `stagione`, `fondazione`, `Paese`) VALUES ('SerieA', 'seriea.png', 'Serie A', '2016-2017', 1898, 'Italia');
INSERT INTO `campionato` (`idcampionato`, `logoc`, `nome`, `stagione`, `fondazione`, `Paese`) VALUES ('Liga Santander', 'liga.png', 'Liga Santander', '2016-2017', 1928, 'Spagna');
INSERT INTO `campionato` (`idcampionato`, `logoc`, `nome`, `stagione`, `fondazione`, `Paese`) VALUES ('PremierLeague', 'premier.png', 'Premier League', '2016-2017', 1888, 'Inghilterra');
INSERT INTO `campionato` (`idcampionato`, `logoc`, `nome`, `stagione`, `fondazione`, `Paese`) VALUES ('Bundesliga', 'bundesliga.png', 'Bundesliga', '2016-2017', 1971, 'Germania');
...
Fusce quis lacus rhoncus tellus venenatis aliquet ac in diam. Etiam dapibus mauris nec dolor tincidunt dignissim. Fusce ullamcorper augue eu mi molestie aliquam. Vivamus turpis elit, lobortis a varius et, aliquam id arcu. Praesent tempus mauris sit amet odio malesuada, sit amet mollis nisi congue. Cras luctus enim urna. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;',  'SerieA,Juventus FC,calciomercato,bignews,Portogallo','Goal.com');

INSERT INTO `notizie` ( `datan`, `titolo`, `immagine`, `articolo`,`tag`,`fonte`) VALUES ( '2018-06-12', 'Atletico Madrid campione dell´EuropaLeague', 'atletico.jpg', 'Suspendisse ullamcorper ac turpis dignissim consequat. Fusce id vulputate est, non hendrerit quam. Curabitur et ullamcorper ante. In faucibus, nulla in viverra pretium, massa turpis mattis magna, ut ornare justo erat quis enim. Vestibulum scelerisque dolor condimentum nibh tempor consequat. Nullam at mi ornare, volutpat velit ut, finibus libero. Ut ligula nisl, porttitor eget quam nec, hendrerit tempor neque. Nullam justo nisi, feugiat et luctus eu, luctus nec urna. Praesent vitae maximus odio. Pellentesque maximus odio et tempus facilisis. Phasellus blandit ornare lorem sed pulvinar. Morbi sed metus interdum, fermentum neque vel, feugiat urna. Praesent mattis iaculis porta. Nunc finibus placerat sapien maximus efficitur. Fusce in tristique metus.

Aliquam a urna non diam viverra scelerisque. Quisque turpis diam, interdum sed nisl vel, commodo molestie elit. Aliquam fermentum rhoncus felis, vitae interdum ante consequat vel. Quisque a cursus nunc, vel placerat massa. Integer ut neque enim. Sed pulvinar turpis nec lectus rhoncus malesuada. Aliquam suscipit tortor magna, id consequat ante dignissim quis. Ut a rhoncus magna, sed vulputate massa.

Fusce quis lacus rhoncus tellus venenatis aliquet ac in diam. Etiam dapibus mauris nec dolor tincidunt dignissim. Fusce ullamcorper augue eu mi molestie aliquam. Vivamus turpis elit, lobortis a varius et, aliquam id arcu. Praesent tempus mauris sit amet odio malesuada, sit amet mollis nisi congue. Cras luctus enim urna. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae
Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;',  'SerieA,Juventus FC,calciomercato,bignews,Portogallo','Goal.com');
INSERT INTO `notizie` ( `datan`, `titolo`, `immagine`, `articolo`,`tag`,`fonte`) VALUES ( '2018-06-7', 'Cristiano Ronaldo a secco,vediamo per quanto dura ancora?', 'cristianojuve.jpg', 'Suspendisse ullamcorper ac turpis dignissim consequat. Fusce id vulputate est, non hendrerit quam. Curabitur et ullamcorper ante. In faucibus, nulla in viverra pretium, massa turpis mattis magna, ut ornare justo erat quis enim. Vestibulum scelerisque dolor condimentum nibh tempor consequat. Nullam at mi ornare, volutpat velit ut, finibus libero. Ut ligula nisl, porttitor eget quam nec, hendrerit tempor neque. Nullam justo nisi, feugiat et luctus eu, luctus nec urna. Praesent vitae maximus odio. Pellentesque maximus odio et tempus facilisis. Phasellus blandit ornare lorem sed pulvinar. Morbi sed metus interdum, fermentum neque vel, feugiat urna. Praesent mattis iaculis porta. Nunc finibus placerat sapien maximus efficitur. Fusce in tristique metus.
...
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('atalanta.png', 'Atalanta BC', 'Bergamo', 1907, 'Antonio Percassi', 'sit002', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('bologna.png', 'Bologna FC 1909', 'Bologna', 1909, 'Joey Saputo', 'sit003', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('chievo.png', 'AC Chievo Verona', 'Verona', 1928, 'Luca Campedelli', 'sit016', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('cagliari.png', 'Cagliari Calcio', 'Cagliari', 1920, 'Tommaso Giulini', 'sit011', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('empoli.png', 'Empoli FC', 'Empoli', 1920, 'Fabrizio Corsi', 'sit012', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('sassuolo.png', 'US Sassuolo', 'Sassuolo', 1920, 'Carlo Rossi', 'sit018', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('juventus.png', 'Juventus FC', 'Torino', 1897, 'Andrea Agnelli', 'sit001', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('roma.png', 'AS Roma', 'Roma', 1927, 'James Pallotta', 'sit010', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('inter.png', 'FC Internazionale', 'Milano', 1908, 'Erick Thohir', 'sit004', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('milan.png', 'AC Milan', 'Milano', 1899, 'Li Yonghong', 'sit004', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('lazio.png', 'SS Lazio', 'Roma', 1900, 'Claudio Lotito', 'sit010', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('pescara.png', 'Delfino Pescara 1936', 'Pescara', 1936, 'Daniele Sebastiani', 'sit017', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('palermo.png', 'US città di Palermo', 'Palermo', 1900, 'Paul Baccaglini', 'sit007', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('udinese.png', 'Udinese Calcio', 'Udine', 1896, 'Giampaolo Pozzo', 'sit015', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('sampdoria.png', 'UC Sampdoria', 'Genova', 1946, 'Massimo Ferrero', 'sit014', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('genoa.png', 'Genoa CFC', 'Genova', 1893, 'Enrico Preziosi', 'sit014', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('crotone.png', 'FC Crotone', 'Crotone', 1922, 'Raffaele Vrenna', 'sit013', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('torino.png', 'Torino FC', 'Torino', 1906, 'Urbano Cairo', 'sit008', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('fiorentina.png', 'ACF Fiorentina', 'Firenze', 1926, 'Mario Cognigni', 'sit006', 'SerieA');
INSERT INTO `squadra` (`logo`,`nome`, `città`, `fondazione`, `presidente`, `stadio`, `campionato`) VALUES ('napoli.png', 'SSC Napoli', 'Napoli', 1926, 'Aurelio de Laurentis', 'sit009', 'SerieA');
...
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P1', 'Atalanta BC', 'SS Lazio', 1, 'sit002', 3, 4, 'A01', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P2', 'Bologna FC 1909', 'FC Crotone', 1, 'sit003', 1, 0, 'A08', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P3', 'AC Chievo Verona', 'FC Internazionale', 1, 'sit016', '2', 0, 'A11', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P4', 'Empoli FC', 'UC Sampdoria', 1, 'sit012', 0, 1, 'A13', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P5', 'Genoa CFC', 'Cagliari Calcio', 1, 'sit014', 3, 1, 'A16', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P6', 'US città di Palermo', 'US Sassuolo', 1, 'sit007', 0, 1, 'A17', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P7', 'Delfino Pescara 1936', 'SSC Napoli', 1, 'sit017', 2, 2, 'A09', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P8', 'AC Milan', 'Torino FC', 1, 'sit004', 3, 2, 'A04', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P9', 'Juventus FC', 'ACF Fiorentina', 1, 'sit001', 2, 1, 'A14', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G1P10', 'AS Roma', 'Udinese Calcio', 1, 'sit010', 4, 0, 'A05', 'SerieA','2018-06-13', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P1', 'SS Lazio', 'Juventus FC', 2, 'sit010',DEFAULT ,DEFAULT , 'A03', 'SerieA','2018-10-12', '21:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P2', 'SSC Napoli', 'AC Milan', 2, 'sit009',DEFAULT ,DEFAULT , 'A02', 'SerieA','2018-10-12', '18:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P3', 'FC Internazionale', 'US città di Palermo', 2, 'sit004',DEFAULT ,DEFAULT , 'A01', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P4', 'UC Sampdoria', 'Atalanta BC', 2, 'sit014',DEFAULT ,DEFAULT , 'A04', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P5', 'Cagliari Calcio', 'AS Roma', 2, 'sit011',DEFAULT ,DEFAULT , 'A06', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P6', 'Torino FC', 'Bologna FC 1909', 2, 'sit008',DEFAULT ,DEFAULT , 'A14', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P7', 'Udinese Calcio', 'Empoli FC', 2, 'sit015',DEFAULT ,DEFAULT , 'A17', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P8', 'US Sassuolo', 'Delfino Pescara 1936', 2, 'sit018',DEFAULT ,DEFAULT , 'A12', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P9', 'ACF Fiorentina', 'AC Chievo Verona', 2, 'sit006',DEFAULT ,DEFAULT , 'A11', 'SerieA','2018-10-13', '15:00:00');
INSERT INTO `partita` (`idpartita`, `squadracasa`, `squadraospite`, `ngiornata`, `stadio`, `golcasa`, `golospite`, `arbitro`, `campionato`,`datap`, `ora`) VALUES ('G2P10', 'FC Crotone', 'Genoa CFC', 2, 'sit008',DEFAULT ,DEFAULT , 'A10', 'SerieA','2018-10-13', '21:00:00');
